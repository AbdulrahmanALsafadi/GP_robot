...
# Use abs() to take only positive values
    ...
    #def InvFoot(self, theta1 ,theta2 , gamma ): 
    #        InvFoot = (theta1 - theta2) + 40
    #        return InvFoot
    ...
    def mainRight(xr, zr, yr, alphar, betar, gammar):
        ...
        #newGammar = inv.InvFoot(theta1l  , theta2l , gammar )

        # Print the results right 
        print(f"Theta 1 Lower motor Right: {theta1l} degrees")
        print(f"Theta 2 knee Right: {theta2l} degrees")
        print(f"gama Right: {gammar} degrees")
        ...
        return theta1shiftedr, theta2r, theta3shiftedr, thetaHipshiftedr, theta1shiftedl, theta2l, theta3shiftedl , thetaHipshiftedl, newgammar
